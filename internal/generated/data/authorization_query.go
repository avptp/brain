...
type AuthorizationQuery struct {
	...
	loadTotal  []func(context.Context, []*Authorization) error
...
func (aq *AuthorizationQuery) Order(o ...authorization.OrderOption) *AuthorizationQuery {
...
func (aq *AuthorizationQuery) Clone() *AuthorizationQuery {
	...
	return &AuthorizationQuery{
		config:     aq.config,
		ctx:        aq.ctx.Clone(),
		order:      append([]authorization.OrderOption{}, aq.order...),
...
func (aq *AuthorizationQuery) prepareQuery(ctx context.Context) error {
	...
	if authorization.Policy == nil {
		return errors.New("data: uninitialized authorization.Policy (forgotten import data/runtime?)")
	}
	if err := authorization.Policy.EvalQuery(ctx, aq); err != nil {
		return err
	}
	return nil
}
...
func (aq *AuthorizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Authorization, error) {
	...
	if query := aq.withPerson; query != nil {
		if err := aq.loadPerson(ctx, query, nodes, nil,
			func(n *Authorization, e *Person) { n.Edges.Person = e }); err != nil {
			return nil, err
		}
	}
...
func (aq *AuthorizationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authorization.Table, authorization.Columns, sqlgraph.NewFieldSpec(authorization.FieldID, field.TypeUUID))
	_spec.From = aq.sql
	...
	if fields := aq.ctx.Fields; len(fields) > 0 {
		...
		if aq.withPerson != nil {
			_spec.Node.AddColumnOnce(authorization.FieldPersonID)
		}
	}
