...
func (r *personResolver) Authentications(ctx context.Context, obj *data.Person, after *data.Cursor, first *int, before *data.Cursor, last *int) (*data.AuthenticationConnection, error) {
	return obj.
